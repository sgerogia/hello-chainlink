...
/**
 * @title The Mock Chainlink Operator contract
 * @notice Node operators can deploy this contract to fulfill requests sent to them
 */
contract MockOperator is AuthorizedReceiver, ConfirmedOwner, LinkTokenReceiver, OperatorInterface, WithdrawalInterface {
 ...
 * @notice Creates the Chainlink request. This is a backwards compatible API
   ...
   */
    function oracleRequest(
        ...
        console.log("\tMockOperator.oracleRequest");
   ...
   */
    function operatorRequest(
        ...
        console.log("\tMockOperator.operatorRequest");
 ...
 * @notice Called by the Chainlink node to fulfill requests
   ...
   */
    ...
    returns (bool)
    {
        console.log("\tMockOperator.fulfillOracleRequest");
   ...
   */
    ...
    returns (bool)
    {
        console.log("\tMockOperator.fulfillOracleRequest2");
